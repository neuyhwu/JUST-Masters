...
│       └── academic-writing-workshop/ # 📝 学术写作工坊模块 (4个文件)
├── venv/                             # Python虚拟环境
├── .github/
│   └── workflows/
...
```yaml
site_url: https://neuyhwu.github.io/JUST-Masters/
```
...
- 📚 知识库: [JUST-Masters](https://neuyhwu.github.io/JUST-Masters/)
